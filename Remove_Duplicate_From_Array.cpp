// This is my solution to Leetcode problem #26. Remove Duplicates from Sorted Array
...
int main(){
  Solution sol;
  vector<int> nums = {1,2,3,3,3,4,5,6,7,8,9};
  int result = sol.removeDuplicates(nums);
  cout<<"number of unique numbers in the array = "<<result<<endl;
  return result;
}