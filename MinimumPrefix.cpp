//This is my solution to Leetcode Problem: Minimum Prefix Removal to Make Array Strictly Increasing
...
int main(){
  Solution  sol;
  vector<int> nums = {1,-1,2,3,3,4,5,6};
  int ans = sol.minimumPrefixLength(nums);
  cout<<"The answer to this problem is: "<<ans<<endl;
  return 0;
}