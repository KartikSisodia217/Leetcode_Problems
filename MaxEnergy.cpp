//This is my solution to Leetcode Problem #3147: Taking Maximum Energy From the Mystic Dungeon
...
i + k) does not exist.
In other words, you will choose a starting point and then teleport with k jumps until you reach the 
...
int main(){
  ...
  int k = 3;
  cout<<"The maximum possible energy in this case is: "<<sol.maximumEnergy(energy,k)<<endl;
  return 0;
}