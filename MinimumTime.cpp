//This is my solution to Leetcode Problem #1266: Minimum Time Visiting All Points

/*

On a 2D plane, there are n points with integer coordinates points[i] = [xi, yi]. Return the minimum 
time in seconds to visit all the points in the order given by points.You can move according to these 
rules:
...
int main(){
  ...
  cout<<"The minimum time taken to visit all points is "<<sol.minTimeToVisitAllPoints(points)<<" secs."<<endl;
  return 0;
}