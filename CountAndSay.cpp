//This is my solution to Leetcode Problem #38: Count And Say. 
...
the count of the characters (length of the run). For example, to compress the string "3322251" we 
...
int main(){
  ...
  cin>>n;
  cout<< "CountAndSay("<<n<<") is : "<<sol.countAndSay(n)<<endl;
  return 0;
}